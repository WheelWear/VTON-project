...
class CatVTONPipeline_Train:
    ...
    def __call__(
        ...
        num_inference_steps: int = 2, #50이 원래 값
        ...
        **kwargs
        ...
        # print("masked_latent shape:", masked_latent.shape)
        # print("condition_latent shape:", condition_latent.shape)
        # print("mask_latent shape:", mask_latent.shape)
        # print("masked_latent_concat shape (before slicing):", masked_latent_concat.shape)
        ...
        with tqdm.tqdm(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                # print("model_input",inpainting_latent_model_input.shape) # ([2, 9, 256, 96])
                ...
                # print("model_ouput", noise_pred.shape) #([2, 4, 256, 96])
                # perform guidance
