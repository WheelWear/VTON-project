...
def process_tryon_experiment(
    ...
    if lora_weight_name and lora_weight_name != "none":
        ...
        # print(state_dict.keys())  # LoRA 키 포함 여부 확인
        # print(state_dict["to_q.lora_A"].norm())  # 가중치 값이 0에 가까운지 확인
    # 추론 
    with torch.no_grad():
...
if __name__ == "__main__":
    #C:\Users\coldbrew\VTON-project\tryon-images\하의2.png
    ...
    cloth_type = "upper"
    lora_weight_name = "best_loss_lora_r16_lr1e-05_ep28_20250224_134842.pt"  # "none" 또는 특정 LoRA 가중치 파일 이름
    # lora_weight_name = ""
